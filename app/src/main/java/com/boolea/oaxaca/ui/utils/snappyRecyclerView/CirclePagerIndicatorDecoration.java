package com.boolea.oaxaca.ui.utils.snappyRecyclerView;
...
public class CirclePagerIndicatorDecoration extends RecyclerView.ItemDecoration {
    ...
    public CirclePagerIndicatorDecoration(int colorActive, int strokeColor) {
        this.colorActive = colorActive;
        mPaint.setStrokeWidth(mIndicatorStrokeWidth);
        mPaint.setStyle(Paint.Style.FILL);
        mPaint.setAntiAlias(true);
        strokePaint.setStrokeWidth(mIndicatorStrokeWidth);
    ...
    private void drawHighlights(Canvas c, float indicatorStartX, float indicatorPosY,
        ...
        if (progress == 0F) {
            ...
            c.drawCircle(highlightStart, indicatorPosY, mIndicatorItemLength / 1.7F, strokePaint);
            ...
            c.drawCircle(highlightStart + partialLength, indicatorPosY, mIndicatorItemLength / 1.7F, strokePaint);
